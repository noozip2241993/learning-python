'''
9.9 (Telephone-Number Word Generator) In Exercise 5.12, you created a telephone number 
word-generator program. Modify that program to write its output to a text file.
...
with open (FULLPATH, mode='w') as phone_words:
    for word in words:
        phone_words.write(f'{word}\n')